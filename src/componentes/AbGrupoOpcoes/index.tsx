...
const colorFont = ({selecionado}: any) => selecionado ? '#ffffff ': '#EB9B00';
...
const SectionEstilizada = styled.section<{
    ...
    border-width: 1px;
    background-image: ${
        props => props.selecionado? gradientBg : '#ffffff'
    };
...
const AbGrupoOpcoes = ({ opcoes, onChange, valorPadrao }: AbGrupoOpcoesProps) => {
    const [ selecao, setSelecao ] = useState<AbGrupoOpcaoProps | null>(valorPadrao ?? null);
